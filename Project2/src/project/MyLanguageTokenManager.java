/* Generated By:JavaCC: Do not edit this line. MyLanguageTokenManager.java */
package project;

/** Token Manager. */
public class MyLanguageTokenManager implements MyLanguageConstants
{
...
/** Constructor. */
public MyLanguageTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public MyLanguageTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
